  ...
  return (
    <>
      <div className= {hero.bg}>
        ...
        <h2 className='text-6xl font-bold md:text-7xl '>I'm Void Sir.</h2>
        <p className='text-center text-xl  md:w-[60%]'>Tattoos have their own unique power and magic.Ther not only beautify the body but also the psyche</p>
